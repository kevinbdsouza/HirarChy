...
class Config:
    def __init__(self):
        ...
        self.cell = "GM12878"
        self.chr_train_list = [19, 21, 22]
        self.chr_test_list = [19, 21, 22]
        ...
        self.model_name = "multi_scale3"

        "Output Directories"
        self.proj_dir = "/home/kevindsouza/Documents/projects/PhD/HirarChy/"
